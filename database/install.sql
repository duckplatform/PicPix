...
CREATE TABLE IF NOT EXISTS events (
	...
	archive_status ENUM('none', 'pending', 'ready', 'failed') NOT NULL DEFAULT 'none',
	archive_file VARCHAR(255) NULL,
	archive_size_bytes BIGINT UNSIGNED NULL,
	archive_photo_count INT UNSIGNED NULL,
	archive_error VARCHAR(255) NULL,
	archive_generated_at DATETIME NULL,
	created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	PRIMARY KEY (id),
